...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "An interactive Harry Potter encyclopedia: characters, spells, hidden lore, creatures, locations, and magical games." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Wizarding World Explorer" },
      { name: "twitter:description", content: "An interactive Harry Potter encyclopedia: characters, spells, hidden lore, creatures, locations, and magical games." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/fabcf55b-efb4-47d1-a612-4a5748e18cfa/id-preview-90e37588--cb380642-fcfc-4b8a-8172-aa6e2001b089.lovable.app-1782392706437.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/fabcf55b-efb4-47d1-a612-4a5748e18cfa/id-preview-90e37588--cb380642-fcfc-4b8a-8172-aa6e2001b089.lovable.app-1782392706437.png" },
    ],
    links: [
